    ...
    return (
        <div>
            ...
            <div className={styles.twoColLayout}>
                ...
                {/* Logo + Environment berdampingan di mobile via visualUploadStack */}
                <div className={styles.visualUploadStack}>
                    ...
                    {logoPreview ? (
                        ...
                        <img src={logoPreview} alt="Logo preview" className={styles.uploadPreviewImg} />
                        ...
                        <span className={styles.dropZoneText}>Klik untuk upload logo</span>
                        <span className={styles.dropZoneHint}>PNG, JPG hingga 5MB</span>
                        <input type="file" accept="image/*" onChange={handleLogoChange} />
                        </label>
                    )}
                    </div>
                    ...
                    {envPreview ? (
                        <div className={styles.uploadPreviewWrap}>
                        <img src={envPreview} alt="Environment preview" className={styles.uploadPreviewImgEnv} />
                        <label className={styles.uploadPreviewChange}>
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                            <path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" />
                            </svg>
                            Ganti Foto
                            <input type="file" accept="image/*" onChange={handleEnvChange} />
                        </label>
                        </div>
                    ) : (
                        <label className={styles.dropZone}>
                        ...
                        <span className={styles.dropZoneText}>Klik untuk upload foto</span>
                        <span className={styles.dropZoneHint}>PNG, JPG hingga 10MB</span>
                        <input type="file" accept="image/*" onChange={handleEnvChange} />
                        </label>
                    )}
                    </div>
                ...
                <div className={styles.optionalUploadCard}>
                    ...
                    <p>PDF, DOC, atau TXT tentang profil kampus.</p>
                    </div>
                    ...
                    <label className={styles.dropZoneCompact}>
                        ...
                        <div className={styles.dropZoneTextGroup}>
                            <span className={styles.dropZoneText}>Upload file referensi</span>
                            <span className={styles.dropZoneHint}>PDF · DOC · DOCX · TXT</span>
                        </div>
                        </div>
                        <input type="file" accept="image/*,.pdf,.txt,.doc,.docx" onChange={handleFileChange} />
                    </label>
                    )}
                </div>
                </div>
