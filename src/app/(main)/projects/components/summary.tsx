...
export default function ProjectSummary({
  ...
  return (
    <div>
      ...
      <div ref={briefRef} style={{ backgroundColor: "transparent" }}>
        <div className={styles.summaryLayout}>
          ...
          <div className={styles.summaryPreviewPanel}>
            ...
            <div className={styles.summaryPreviewCard}>
              <div className={styles.summaryPreviewCardHeader}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#868e96" strokeWidth="2.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
              ...
              <div className={styles.summaryLogoWrap}>
                {logoPreview ? (
                  ...
                  <div style={{ color: "#ced4da", fontSize: "0.8rem", textAlign: "center" }}>
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ display: "block", margin: "0 auto 0.5rem" }}><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                    Belum ada logo
                  </div>
                )}
              </div>
            ...
            <div className={styles.summaryPreviewCard}>
              <div className={styles.summaryPreviewCardHeader}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#868e96" strokeWidth="2.5"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
              ...
              <div className={styles.summaryEnvWrap}>
                {envPreview ? (
                  ...
                  <div style={{ height: "160px", display: "flex", alignItems: "center", justifyContent: "center", color: "#ced4da", fontSize: "0.8rem", flexDirection: "column", gap: "0.5rem" }}>
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
                    Belum ada foto
                  </div>
                )}
              </div>
            ...
            <div className={styles.summaryInfoCard}>
              <div className={styles.summaryInfoRow}>
                ...
                <span className={styles.summaryInfoValue}>
                  {institutionName}{schoolLevel ? ` · ${schoolLevel}` : ""}
              ...
              <div className={styles.summaryInfoRow}>
                ...
                <span className={styles.summaryInfoValue}>{eventContent} {videoDuration ? `(${videoDuration})` : ""}</span>
              </div>
              <div className={styles.summaryDivider} />
              <div className={styles.summaryInfoRow}>
              ...
              <div className={styles.summaryInfoRow}>
                ...
                <span className={styles.summaryInfoValue} style={{ fontStyle: "italic" }}>"{selectedKeyMessage}"</span>
              </div>
              {prompt && (
                <>
                  <div className={styles.summaryDivider} />
          ...
          <div className={styles.summaryEditPanel}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "0.75rem", paddingTop: "0.5rem" }}>
              <button className={styles.btnGhost} onClick={prevStep} style={{ margin: 0 }}>
                ← Edit Tema
              </button>
